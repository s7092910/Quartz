...
namespace Quartz
{
    public class XUiC_VehicleHealth : XUiC_HUDStatbar
    {
        ...
        {
            return vehicle != null ? vehicle.GetVehicle().GetHealthPercent() : 0;
        }

        protected override float GetCurrentStat()
        {
            return vehicle != null ? vehicle.GetVehicle().GetHealth() : 0;
        }

        protected override float GetMaxStat()
        {
            return vehicle != null ? vehicle.GetVehicle().GetMaxHealth() : 0;
        }
